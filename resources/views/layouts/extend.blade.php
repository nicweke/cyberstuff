...
<head>
    ...
    <link href="{{asset('assets/css/cyber.min.css')}}"
...
<body>
    ...
    <div data-collapse="medium" data-animation="default" data-duration="400" data-easing="ease" data-easing2="ease"
        ...
        <div class="container-nav w-container"><a href="{{route('home')}}" class="logo w-nav-brand"><img loading="lazy"
            ...
            <div role="navigation" class="nav w-nav-menu">
                <div class="nav-layout">
                    <div data-w-id="33b7d129-eee1-8e9f-9296-dc2ef7490c67" class="nav-dropdown">
                        <div data-w-id="33b7d129-eee1-8e9f-9296-dc2ef7490c68" class="nav-link features">
                            <div>Features</div>
                        </div>
                        <div data-w-id="33b7d129-eee1-8e9f-9296-dc2ef7490c6b" class="nav-dropdown-list">
                            <div class="div-block-32"></div>
                            <div class="w-layout-grid grid-3"><a
                                    id="w-node-_33b7d129-eee1-8e9f-9296-dc2ef7490c6e-f7490c61" href="/feedback-friday"
                                ...
                                </a><a id="w-node-_33b7d129-eee1-8e9f-9296-dc2ef7490c80-f7490c61" href="/kudos"
                                    class="link-block-6 w-inline-block">
                                    <div class="div-block-26"><img width="112" loading="lazy"
                                ...
                                </a><a id="w-node-_0666f528-168f-bb6e-7050-5ae9102d921c-f7490c61" href="/analytics"
                                    class="link-block-6 w-inline-block">
                            ...
                            <div class="footer-menu">
                                <div class="footer-menu-col">
                                    ...
                                    <ul role="list" class="footer-menu-list w-list-unstyled">
                                        <li class="footer-menu-item"><a href="" class="footer-menu-link">About
                                                us</a></li>
                                        <li class="footer-menu-item"><a href=""
                                                class="footer-menu-link">Careers</a></li>
                                        <li class="footer-menu-item"><a href=""
                                                class="footer-menu-link">Pricing</a></li>
                                        <li class="footer-menu-item"><a href="" class="footer-menu-link">Blog</a>
                                        </li>
                                ...
                                <div class="footer-menu-col">
                                    ...
                                    <ul role="list" class="footer-menu-list w-list-unstyled">
                                        ...
                                        <li class="footer-menu-item"><a href="" class="footer-menu-link">Kudos</a>
                                        </li>
                                        <li class="footer-menu-item"><a href=""
                                                class="footer-menu-link">Analytics</a></li>
                                        <li class="footer-menu-item"><a href=""
                                                class="footer-menu-link">Rewards</a></li>
                                    </ul>
                                </div>
                                <div class="footer-menu-col">
                                    <h6 class="footer-title">Resources</h6>
                                    <ul role="list" class="footer-menu-list w-list-unstyled">
                                        <li class="footer-menu-item"><a href="" class="footer-menu-link">Demo</a>
                                        </li>
                                        <li class="footer-menu-item"><a href="/skills" aria-current="page"
                                                class="footer-menu-link w--current">Develop skills</a></li>
                                        <li class="footer-menu-item"><a href=""
                                ...
                                <div class="footer-menu-col">
                                    ...
                                    <ul role="list" class="footer-menu-list w-list-unstyled">
                                        ...
                                        <li class="footer-menu-item"><a href="" class="footer-menu-link">DPA</a>
                                        </li>
                                        <li class="footer-menu-item"><a href=""
            ...
            <header id="cookie-dialog" class="sticky-footer">
                <nav class="w-container">
                    <div class="w-row">
                        <div class="column-65 w-col w-col-9">
                            <p class="paragraph">By using this Website, you agree to the storing of cookies on your device to
                                analyze site usage and assist in marketing efforts. View our <a href="/legal/privacy">Privacy
                                    Policy</a>.</p>
                        </div>
                        <div class="column-64 w-col w-col-3"><a id="cookie-dialog-button" href="#"
                                class="cookie-dialog-button w-button">Acknowledge</a></div>
                    </div>
                </nav>
            </header>
